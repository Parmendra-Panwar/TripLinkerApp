...
const Filter = ({ categories }: { categories: Category[] }) => {
    ...
    // Use a compatible type that has id and name
    const allOption: { id: string; name: string } = { id: 'all', name: 'All' };
    const filterData = categories ? [allOption, ...categories] : [allOption];
